...
namespace DarulAman.Controllers
{
    public class tbl_AdminController : Controller
    {
        ...
        {
            ViewBag.ACCESS_LEVEL_FID = new SelectList(db.tbl_AccessLevel, "ID", "ACCESS_LEVEL");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ADMIN_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD,ADDRESS,CONTACT,ACCESS_LEVEL_FID")] tbl_Admin tbl_Admin)
        {
            ...
            ViewBag.ACCESS_LEVEL_FID = new SelectList(db.tbl_AccessLevel, "ID", "ACCESS_LEVEL", tbl_Admin.ACCESS_LEVEL_FID);
            return View(tbl_Admin);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ADMIN_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD,ADDRESS,CONTACT,ACCESS_LEVEL_FID")] tbl_Admin tbl_Admin)
        {
            if (ModelState.IsValid)
            {
