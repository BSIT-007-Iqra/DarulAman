...
namespace DarulAman.Controllers
{
    public class tbl_AccessLevelController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,ACCESS_LEVEL")] tbl_AccessLevel tbl_AccessLevel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,ACCESS_LEVEL")] tbl_AccessLevel tbl_AccessLevel)
        {
            if (ModelState.IsValid)
            {
